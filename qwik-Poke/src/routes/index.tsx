...
export default component$(() => {
  ...
  return (
    ...
    <>
      ...
      <PokemonImage  id={pokemonId.value} backImage={showBack.value}></PokemonImage>
      ...
      <div class="mt-8">
        ...
        <button onClick$={()=> showBack.value = !showBack.value } class="btn btn-primary">Turn back</button>
      </div>
    </>
  );
